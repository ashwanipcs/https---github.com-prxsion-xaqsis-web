	...
	*/
    ...
    public function store(Request $request)
    {
		...
		foreach($activityArr as $key=>$items)
		{
			...
			$predecessorsParam[$key] = array(
									$projectActivities->uuid => $projectActivities->name,  

								);
			$predecessors =	json_encode($predecessorsParam);
			...
			$paramData[$key] = array(
					...
					"predecessors" 			=> json_encode($predecessors, true, JSON_UNESCAPED_SLASHES),				
    ...
    public function edit(Request $request)
    {
		...
		$uuid = "a260207d-ba8f-4cb6-bd81-4a538279d38e";
    ...
    public function update(Request $request)
    {
		...
		$requestData = [				
				...
				"name" 					=> "E1010-Flooring",
				"mostlikely_cost" 		=> "392818.559897805",
