...
class MCSAnalysisController extends Controller
{
     ...
     * @return \Illuminate\Http\Response
     */
    public function doCreate(Request $request, $project_uuid, $simulation_type)
    {	
		...
		return view('mcsanalysis.summary',compact('peojectsArr','project_uuid','simulationArr','simulation_uuid','summaryResArr','costdetails','activityArr','activityname'));
