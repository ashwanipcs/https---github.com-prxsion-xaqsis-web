...
class ActivityController extends Controller
{
    ...
    {	
		...
		if($result->status->response==500)
		{
			...
			return view('activity.index',compact('res'));
		}		 
    }
	/**
	...
	*/
    ...
    public function importActivity(Request $request)
    {
		...
		$requestData[0] = array(				 
				"name" 				=> "VY1010-CommercialEquipment1",
				"description" 		=> "VY1010-CommercialEquipment1",
				"is_system"			=> false,
				"is_active"			=>  true ,
				"modified_by" 		=> $this->account_uuid,
		...
		$requestData[1] = array(				 
				"name" 				=> "ER1010-CommercialEquipment1",
				"description" 		=> "ER1010-CommercialEquipment1",
				"is_system"			=> false,
				"is_active"			=>  true  ,
				"modified_by" 		=> $this->account_uuid,
		...
		$requestData[2] = array(				 
				"name" 				=> "AY1010-CommercialEquipment1",
				"description" 		=> "AYs1010-CommercialEquipment1",
				"is_system"			=> false,
				"is_active"			=>  true  ,
				"modified_by" 		=> $this->account_uuid,
