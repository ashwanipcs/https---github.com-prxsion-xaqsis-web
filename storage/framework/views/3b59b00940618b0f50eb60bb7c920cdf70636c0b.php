        ...
        <div class="container-fluid d-sm-flex justify-content-between">
            ...
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item">
                        <a href="<?php echo e(route('projects')); ?>">Project</a>
                    </li>
                        ...
                        <div class="col-md-12" style="padding: 0 !important;">
								<div class="form-group">
                                    <select class="form-control projectuuid" id="exampleFormControlSelect1 " required>
										...
										<?php if($projects): ?>											
											<?php $__currentLoopData = $projects; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $kp => $p): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>											 
											<option value="<?php echo e($p->uuid); ?>"><?php echo e($p->name); ?></option>
...
$(document).ready(function() {	 
	$('.simulation').on('change', function() {			
		...
		var url = "<?php echo e(url('')); ?>/summary/create/"+project_uuid+"&simulation_type=C?simulation_uuid="+simulation_uuid;
...
<script src="<?php echo e(url('public/assets/js/d3chart.js')); ?>"></script>
<?php $__env->stopSection(); ?>

<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\laravel_demo_app\resources\views/summary/costanalysis.blade.php ENDPATH**/ ?>