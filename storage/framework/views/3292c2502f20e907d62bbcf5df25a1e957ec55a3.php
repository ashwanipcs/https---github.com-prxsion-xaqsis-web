...
<!-- Prism -->
	...
	<link rel="stylesheet" href="<?php echo e(url('public/assets/css/styles.css')); ?>" type="text/css">
        ...
        <div class="container-fluid d-sm-flex justify-content-between">
            ...
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item">
                        <a href="<?php echo e(route('mcs-analysis')); ?>">MCS Analysis</a>
                    </li>
                ...
                <div class="card" style="padding: 28px;">
				 <form name="frmSummary" method="get" action="" id="frmsummary">
                        ...
                        <div class="col-md-12" style="padding: 0 !important;">
								<div class="form-group">
                                    <select name="project_uuid" class="form-control projectuuid" id="exampleFormControlSelect1 " required>
										...
										<?php if($peojectsArr): ?>											
											<?php $__currentLoopData = $peojectsArr; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $items): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>											 
											<option value="<?php echo e($items->uuid); ?>"><?php echo e($items->name); ?></option>
											<?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
										<?php endif; ?>
                                      </select>
                                   
                                </div>
								<input type="hidden" name="simulation_type" value="M"  class="form-control" />
                                <div class="form-group">
                    ...
                    <div class="row">
                        <div class="col-md-12">
						<h3>MCS Summary:</h3>
                            <table id="mcsindextab" class="table table-striped table-bordered">
							  <thead>
								<tr>
								   <th>idx</th>
								  <th>Duration</th>
...
<script src="<?php echo e(url('public/assets/js/apexcharts.min.js')); ?>"></script>
<script>
        ...
        var chart = new ApexCharts(document.querySelector("#mcschartsummary"), options);
        chart.render();
 </script>

<script>
$(document).ready(function (){
    $('.mcsindextab').DataTable();
});
...
$(document).ready(function() {	 
	$('.simulation').on('change', function() {			
		...
		var url = "<?php echo e(url('')); ?>/mcs-analysis/create?"+project_uuid+"&simulation_type=M&simulation_uuid="+simulation_uuid;
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\laravel_demo_app\resources\views/mcsanalysis/index.blade.php ENDPATH**/ ?>