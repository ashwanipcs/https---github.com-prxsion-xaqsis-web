                    ...
                    <div class="row">
                        <div class="col-md-12" style="padding: 0 !important;">
								<div class="form-group">
                                    <select name="simulation_uuid" class="form-control uuid" id="exampleFormControlSelect1 " required>
                                ...
                                <div class="form-group">
                                    <select name="projectActivity_uuid" class="form-control projectActivity" id="exampleFormControlSelect2 " required>
                                        <option value="">-- Select Project Activity--</option>
										@if($activityProjects)
											@foreach($activityProjects as $idx => $val)
											<option value="{{$val->project_uuid}}">{{$val->name}}</option>
											@endforeach
										@endif
                                      </select>
                       ...
                       <!--<div class="col-md-1">
                            <a href="#" class="mr-3 bttnSearch" style="font-size:25px;">
                                <img style="height:20px;" src="{{ url('public/assets/media/image/icons/return.png') }}" alt="logo">
                            </a>
...
$(document).ready(function() {	 
        $('.projectActivity').on('change', function() {
            ...
            var simulation_uuid = $(".uuid").val();
			var project_uuid = $('.projectActivity').val();
			
			alert("simulation uuid "+simulation_uuid+" == project_uuid=="+project_uuid);
			$("#frmsummary").submit();
            e.preventDefault();
			return false;
