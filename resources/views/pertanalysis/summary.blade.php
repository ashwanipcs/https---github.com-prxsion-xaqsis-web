                    ...
                    <div class="row">                        
                        <div class="col-md-12" >                             
                            <div class="table-responsive">                                
								<table id="summaryTablefirst" class="table table-striped table-bordered">
								  <thead>
									<tr>
									  <th>Idx</th>
									  <th>Desired Duration</th>
									  <th>Critical Path Duration </th>
									  <th>Cumulative Probability</th>									   
									</tr>
								  </thead>
								  <tbody>
								   @if( $summaryArr)									  
									  @foreach($summaryArr as $index=>$items)
										@foreach($items->summary as $key=>$val)
									<tr>
									  <td>{{$val->idx}}</td>
									  <td>{{$val->pert_desired_duration}}</td>
									  <td>{{$val->pert_critical_path_duration}}</td>
									  <td>{{$val->pert_cumulative_probability}}</td>
									...
									<ul class="nav nav-tabs" role="tablist">
										...
										<li role="presentation" class="btn btn btn-default"><a href="#example2-tab2" aria-controls="example2-tab2" role="tab" data-toggle="tab">Cost Details</a></li>
												...
												<div class="tab-content">
													...
													<div id="myvideo1"> 
														<div class="r">
															<button onclick="openFullscreen1();">Fullscreen Mode</button>
...
@section('script')
 <script type="text/javascript" src="{{ url('public/assets/dist/jquery.zoomtoo.js') }}"></script>
...
var elem1 = document.getElementById("myvideo1");
