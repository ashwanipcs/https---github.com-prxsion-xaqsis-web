        ...
        <div class="container-fluid d-sm-flex justify-content-between">
            ...
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active" aria-current="page">Cost Head</li>
                </ol>
            </nav>
        </div>
    </div>
            ...
            <div class="col-md-12">
                ...
                <div class="row">
                    <div class="col-md-12 text-right mb-3" >
                        ...
                        &nbsp;&nbsp;
                        <a href="#">
                            <img style="height:36px;" src="{{ url('public/assets/media/image/icons/download.png') }}" alt="logo">
                        </a>
                    </div>
                </div>
                    ...
                    <div class="card-body">
                        <table id="example1" class="table table-striped table-bordered">
                            ...
                            <tr>
                                ...
                                <td> 
                                    <a href="#">
                                        <img style="height:20px;" src="{{ url('public/assets/media/image/icons/edit.png') }}" alt="logo">
                                    </a>
                                    &nbsp;&nbsp;
                                    <a href="#">
...
@section('script')
    ...
    <script src="{{ url('public/assets/js/examples/datatable.js') }}"></script>
