								...
								<th style="width:10%">Actions</th>
								 ...
								 @if($projectactivity)
									...
									@php $item_id = Crypt::encrypt($items->uuid); @endphp
											<tr>
											<td style="width:50%"> 
												<select name="activity_uuid[{{$items->uuid}}]" class="form-control addactivity" id="exampleFormControlSelect1">
											 ...
											 <td style="width:10%"> 
												<select name="predecessors[{{$items->uuid}}][]" class="js-example-basic-single" multiple required>
													<option value="0">-- Select Activity--</option>
											...
											<td ><input type="text" name="mostlikely_cost[{{$items->uuid}}]" class="form-control" value="{{$items->mostlikely_cost}}"></td>
											<td ><input type="text" name="optimistic_cost[{{$items->uuid}}]" class="form-control" value="{{$items->optimistic_cost}}"></td>											
											<td><input type="text" name="pessimistic_cost[{{$items->uuid}}]" class="form-control" value="{{$items->pessimistic_cost}}"></td>
											<td ><input type="text" name="mostlikely_duration[{{$items->uuid}}]" class="form-control" value="{{$items->mostlikely_duration}}"></td>											
											<td ><input type="text" name="optimistic_duration[{{$items->uuid}}]" class="form-control" value="{{$items->optimistic_duration}}"></td>
											<td ><input type="text" name="pessimistic_duration[{{$items->uuid}}]" class="form-control" value="{{$items->pessimistic_duration}}"></td>
											
											<td style="float: right;margin: 11px 9px 9px 11px;">
											  
												<input name="uuid[{{$items->uuid}}]" class="form-check-input" type="hidden" value="{{$items->uuid}}">
											   
											<input name="is_active[{{$items->uuid}}]" class="form-check-input" type="checkbox" id="gridCheck1" @if($items->is_active==1) checked @else "" @endif></td>													 
											<td> 
...
$(document).ready(function(){
	$(".addCF").click(function(){
				...
				htmlOpt +='<select name="newactivity_uuid[]" class="form-control addactivity" id="exampleFormControlSelect1" required>';
				...
				htmlOpt +='<select name="newpredecessors[][]" class="js-example-basic-single" multiple required>';
				htmlOpt +=' <option value="">-- Select Activity--</option>';
				...
				htmlOpt +='</select>';
				htmlOpt +='</td>';
				htmlOpt +='<td ><input type="text" name="newmostlikely_cost[]" class="form-control" value="0"></td>';
				htmlOpt +='<td ><input type="text" name="newoptimistic_cost[]" class="form-control" value="0"></td>';			
				htmlOpt +='<td><input type="text" name="newpessimistic_cost[]" class="form-control" value="0"></td>';
				htmlOpt +='<td ><input type="text" name="newmostlikely_duration[]" class="form-control" value="0"></td>';				
				htmlOpt +='<td ><input type="text" name="newoptimistic_duration[]" class="form-control" value="0"></td>';
				htmlOpt +='<td ><input type="text" name="newpessimistic_duration[]" class="form-control" value="0"></td>';
				htmlOpt +='<td style="float: right;margin: 11px 9px 9px 11px;">';
				htmlOpt +='<input style="border: white;" name="newis_active" class="form-check-input" type="checkbox">';
				htmlOpt +='<input name="newuuid[]" value="new" type="hidden">';			 
				htmlOpt +='</td>';													 
				htmlOpt +='<td>';
