								 ...
								 @if($projectactivity)
									...
									@php $item_id = Crypt::encrypt($items->uuid); @endphp
											...
											<td style="width:50%"> 
											 ...
											 <td style="width:10%"> 
												<select name="predecessors[{{$items->uuid}}]" class="js-example-basic-single" multiple>
													<option value="0">-- Select Activity--</option>
											...
											<td style="float: right;margin: 11px 9px 9px 11px;">
												...
												<input name="uuid[]" class="form-check-input" type="hidden" value="{{$items->uuid}}">
...
$(document).ready(function(){
	$(".addCF").click(function(){
				...
				htmlOpt +='<input name="newuuid[]" value="Null" type="hidden">';			 
				htmlOpt +='</td>';													 
				htmlOpt +='<td>';
