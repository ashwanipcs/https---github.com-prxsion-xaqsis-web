            ...
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb">
                    <li class="breadcrumb-item">
                        <img style="height: 12px; margin-top: -3px;" src="{{url('assets/media/image/icons/home.png')}}" alt="">
                        <a href="#">Settings</a>
                    </li>
                    ...
                    <div class="card-body text-center">
                        <figure class="avatar avatar-lg m-b-20">
                           @if(file_exists(public_path().'/storage/users/'.Session::get('account_uuid').'/'.Session::get('account_uuid').'.jpg' ))
								<img src="{{url('storage/users/'.Session::get('account_uuid').'/'.Session::get('account_uuid').'.jpg' )}}" class="rounded-circle" alt="...">
                            ...
                            <div class="accordion-row">
                              ...
                              <div class="accordion-body">
                                ...
                                <div class="row mb-2">
                                    ...
                                    <div class="col-6">@if($result->data->is_billing_manager) True @else False @endif</div>
                                </div>
                            ...
                            <div class="accordion-row">
                              ...
                              <div class="accordion-body">
                                <div class="row mb-2">
                                    ...
                                    <div class="col-6">@if($result->data->is_administrator) True @else False @endif</div>
                                </div>
                                <div class="row mb-2">
                                    <div class="col-6 text-muted">Primary:</div>
                                    <div class="col-6">@if($result->data->is_primary) True @else False @endif</div>
                                </div>
                                <div class="row mb-2">
                                    <div class="col-6 text-muted">Active:</div>
                                    <div class="col-6">@if($result->data->is_active) True @else False @endif</div>
                                </div>
                              ...
                              <a href="#" class="accordion-header">
								...
								<div class="form-row">
								  <div class="form-group col-md-6">												
									...
									<input type="hidden" name="uuid" value="{{$result->data->uuid}}">
								</div></div>
                              <div class="accordion-body">
                                        <div class="row mb-2">
                                            <div class="col-6 text-muted">First Name:</div>
                              ...
                              <div class="accordion-body">
                                <div class="row mb-2">
                                 ...
                                 <div class="row mb-2">
                                    <div class="col-6 text-muted">Billing Manager:</div>
                                    <div class="col-6">
									<input class="form-check-input" name="is_billing_manager" value="1"   type="checkbox" id="gridCheck" @if($result->data->is_billing_manager) checked @endif>
									</div>
                                </div>
                            ...
                            <div class="accordion-row">
                              ...
                              <div class="accordion-body">
                                <div class="row mb-2">
                                    <div class="col-6 text-muted">Administrator:</div>
                                    <div class="col-6">
									<input class="form-check-input" name="is_administrator" value="1" type="checkbox" id="gridCheck" @if($result->data->is_administrator) checked @endif>
									</div>
                                </div>
                                <div class="row mb-2">
                                    <div class="col-6 text-muted">Primary:</div>
                                    <div class="col-6"> <input class="form-check-input" name="is_primary" value="1" type="checkbox" id="gridCheck" @if($result->data->is_primary) checked @endif></div>
                                </div>
                                <div class="row mb-2">
                                    <div class="col-6 text-muted">Active:</div>
                                    <div class="col-6"><input class="form-check-input" name="is_active" value="1" type="checkbox" id="gridCheck" @if($result->data->is_active) checked @endif></div>
                                </div>
