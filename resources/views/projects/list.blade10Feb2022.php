								...
								<div class="card">									 
									  <div class="card-body" style="padding: 0.5rem !important;">
												<div class="row">
													...
													<div class="col-md-3"> 
															<div class="row">															 
																<div class="col-md-4">
																<strong>														
																	<a href="javascript:void(0);" data-id="{{ route('projectactivity.create',$item_id )}}" class="addProjectActivity">
												...
												<div class="row">
													...
													<div class="col-md-8">  
													 	 <p><strong> Mean</strong>: 00 &nbsp;&nbsp;&nbsp;<strong>Planned Cost</strong>: 00 &nbsp;&nbsp;&nbsp;<strong>Std</strong>:  00 &nbsp;&nbsp;&nbsp;<strong>Co-Var</strong>: 00 &nbsp;&nbsp;&nbsp;<strong>Z-Value</strong>: .00
													</p>
													</div>
													<div class="col-md-2">  
													 	<a href="">
						...
						<div class="modal-content">
							...
							<div class="modal-body">
								 <div class="form-group row">
										...
										<div class="col-sm-8"><input type="text" name="project_uuid" class="projectuuid" value=""></div>										
											<div class="col-sm-8"><h1><span class="proName"></span></h1></div>
									</div>	
									<div class="form-group row">
