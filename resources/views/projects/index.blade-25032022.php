													...
													<div class="row">
														<div class="col-12" style="padding: 0px 0px 1px 0px; !important;">
															...
															<div class="col-2"></div>															
															 ...
															 <a href="{{route('summary.create', $item->uuid )}}&simulation_type=C">
