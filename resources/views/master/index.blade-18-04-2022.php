...
<body>
    ...
    <header class="header-area">
                    ...
                    <div class="col-lg-12">
                        <nav class="navbar navbar-expand-lg">
                            ...
                            <div class="navbar-btn d-none d-sm-inline-block fontFamily" style="font-weight: bold;">
                                <a class="lightBlueColor" href="{{ route('login') }}">Login</a> | 
								<a class="lightBlueColor" href="{{ route('register') }}" >SignUp</a>
                            </div>
                        </nav> <!-- navbar -->
                    </div>
                </div> <!-- row -->
        ...
        <div id="home" class="header-hero bg_cover d-lg-flex align-items-center" style="background-image: url(assets/images/archi.jpg)">
            <div class="container">
                <div class="row">
                    <div class="col-lg-5">
