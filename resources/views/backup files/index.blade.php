											...
											<div class="row">											 
												<div class="col-8 form-group text-left">													 
													 <strong style="font-size:20px;">{{$item->name}}</strong> &nbsp;&nbsp;														 
														@if($item->is_active==1)
															<img style="height: 12px; margin-top: -3px;" src="{{asset('assets/media/image/icons/online.png')}}" alt=""></span> <br>
														@else
														<img style="height: 12px; margin-top: -3px;" src="{{asset('assets/media/image/icons/offline.png')}}" alt=""></span> <br>
														@endif
												...
												<div class="col-4 form-group text-center">
													<div class="row">
														...
														<a href="javascript: void(0); return false;" data-id="{{$item_id}}xaqsis{{$item->name}}xaqsis{{$item->is_active}}" data-startdate="{{$startdate}}" data-cost="{{$c->cost_trials}}" data-mcspath="{{$c->mcs_include_critical_path}}" data-mcstrials="{{$c->mcs_trials}}" class="editModel" data-toggle="tooltip" data-placement="top" title="Edit">
					...
					<div class="modal-body">
						<div class="form-group row">
							...
							<div class="col-sm-8">
								...
								<input type="text" name="name" class="form-control txtname" style="width: 70%" placeholder="Enter Project Name" required >								 
							</div>
						</div>
						<div class="form-group row">
							<div class="col-sm-4"><strong>Start Date</strong>:</div>							 
							<div class="col-sm-8">								 
								<input type="date" name="project_start_date" class="form-control" style="width: 70%" placeholder="dd-mm-yyyy" required >									 
							</div>
						</div>
						<div class="form-group row">
