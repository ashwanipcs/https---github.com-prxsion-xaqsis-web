						...
						<div class="form-group row">										
							<div class="col-sm-12">
								<div id="License" class="tabcontent" style="display:block;">									 											 												  
									 <div class="row">
											<div class="col-12"> <h3>Credits</h3></div> 
											<div class="col-12"><p>Credits Under Administration are listing below:</p></div> 
											 <div class="col-12"> Purchased: <span>40 </span></div>
											 <div class="col-12"> Used: <span>40 </span></div>
											 <div class="col-12"> Balance: <span>40 </span></div>
									  </div>									  
									</div>
										...
										<div class="row">										  
											<div class="col-12"><p>Uploas XAQSIS License File:</p></div> 
											 <div class="col-12  text-center"> 
												  <div class="form-group  text-center">
													...
													<input type="file" class="form-control text-center" id="filename">
												  </div> 												
											</div><br/>
											<div class="col-12 text-center"> 
											...
											<div class="col-12 text-center"> 
												 <a href="{{route('license.create')}}"> 
												  <button type="button" class="btn btn-primary">By Online</button>
												 </a>
											</div>
										</div>
										</form>
