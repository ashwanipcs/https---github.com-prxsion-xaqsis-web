						...
						<div class="row">										
							<div class="col-sm-12">
								<div class="tabs">
									...
									<form name="frmTab" id="licenseFrm" method="post" action="{{route('license.save')}}" class="needs-validation" novalidate>
										@csrf
										<div class="tab-content">
											<div id="tab1" class="tab active">
											   <div class="form-group row">
													...
													<div class="col-sm-8">
														<label>PREMIUM</label>
														<input type="hidden" name="license_type" value="PREMIUM" class="form-control">	
												...
												<div class="form-group row licensecredits">
													...
													<div class="col-sm-8">
														<input type="text" name="license_credits" value="5" class="form-control txtlicensecredits" required>								
													</div>
												</div>
												<div class="form-group row">
													<div class="col-sm-4"><strong>License Status</strong>:</div>
													<div class="col-sm-8">
														<input  type="checkbox" name="license_status" class="form-check-input" value="false" id="license_status" disabled>
												...
												<div class="form-group row">
													...
													<div class="col-sm-8">
														<input type="text" name="description" class="form-control txtdescription" required>								
													</div>
												</div> 
												<div class="form-group row">
													<div class="col-sm-4"><strong>Is Active</strong>:</div>
													<div class="col-sm-8">
														<input  type="checkbox" name="is_active" class="form-check-input" value="false" id="is_active1" disabled>
														<input type="hidden" name="license_rate" value="100" class="form-control" />	
														<input type="hidden" name="license_validity" value="0" class="form-control" />																
													</div>
												</div>
												<!--<ul class="tab-links">
													 <li>
											...
											<div id="tab2" class="tab">											
												...
												<div class="text-center">													
													<button type="button" class="btn btn-primary prevButton">Previous</button>
													<button type="button" id="licenseBttnSmt" name="sbumitBttn" class="btn btn-primary">Pay Now</button>
												</div>	
												<!--<ul class="tab-links">
													<li>
	...
	<div class="modal-dialog">	
		<div class="modal-content">					 
			<div class="modal-body">
				...
				<img src="{{ url('public/assets/media/image/loadingimage.gif') }}" width="150px;" height="150px;"/>--> 
